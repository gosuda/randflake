...
class TestPackageImports(unittest.TestCase):
    def test_imports(self):
        ...
        generator = Generator(1, RANDFLAKE_EPOCH_OFFSET + 1, RANDFLAKE_EPOCH_OFFSET + 3600, key)
        ...
        with self.assertRaises(ErrInvalidSecret):
            Generator(1, RANDFLAKE_EPOCH_OFFSET + 1, RANDFLAKE_EPOCH_OFFSET + 3600, bytes([0] * 15))
